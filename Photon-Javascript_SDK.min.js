...
(function(k) {
    ...
    var a = function() {
        ...
        a.prototype._send = function(a, b) {
            ...
            else if (!b) throw Error(this._logger.format("PhotonPeer[_send] - Operation", a.req, '- failed, "isConnected" is', this._isConnected,
                ', "isClosing" is', this._isClosing, "!"));
        };
        ...
        a.prototype._parseResponse = function(a, b) {
            switch (a) {
                default: this._dispatchResponse(a, {
                    errCode: b.err,
                    errMsg: b.msg,
                    vals: b.vals
                })
    ...
    (function(a) {
        var m = function(m) {
            ...
            b.prototype.raiseEvent = function(h, g) {
                if (this.isJoined)
                    if (void 0 !== g) this._logger.debug("PhotonPeer.Lite[raiseEvent] - Event", h, ":", g), this.sendOperation(a.Constants.LiteOpCode.RaiseEvent, [a.Constants.LiteOpKey.Code, h, a.Constants.LiteOpKey.Data, g]);
        ...
        var l = function() {
            ...
            d.prototype.initGamePeer = function(f, c) {
                ...
                f.addEventListener(a.Constants.EventCode.Leave, function(c) {
                    ...
                    if (d && e.actors[d]) {
                        var g = e.actors[d];
                        c.vals[a.Constants.ParameterCode.IsInactive] ? (g._setSuspended(!0), e.onActorSuspend(g)) : (e.removeActor(d), e.onActorLeave(g, !1))
                    }
                });
